...
export function TermsPage() {
  return (
    <div>
      <h2>Welcome to Mystoria Studio!</h2>
      <p>
        By accessing Mystoria Dashboard, you agree to be bound by these terms of
      ...
      <h3>1. Terms</h3>
      <p>
        By accessing the website at Mystoria, you are agreeing to be bound by
