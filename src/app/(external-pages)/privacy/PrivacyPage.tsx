...
export function PrivacyPage() {
  return (
    <div>
      ...
      <p>
        At Framework, accessible from https://mystoria.dev, one of our main
        priorities is the privacy of our visitors. This Privacy Policy document
        contains types of information that is collected and recorded by
        Framework and how we use it.
      </p>
      ...
      <p>
        ...
        shared and/or collect in Framework. This policy is not applicable to any
      ...
      <p>
        Framework follows a standard procedure of using log files. These files
      ...
      <p>
        Like any other website, Framework uses "cookies". These cookies are used
      ...
      <p>
        ...
        advertising partners of Framework.
      </p>

      <p>
        Third-party ad servers or ad networks uses technologies like cookies,
        JavaScript, or Web Beacons that are used in their respective
        advertisements and links that appear on Framework, which are sent
      ...
      <p>
        Note that Framework has no access to or control over these cookies that
      ...
      <p>
        Framework's Privacy Policy does not apply to other advertisers or
      ...
      <p>
        Framework does not knowingly collect any Personal Identifiable
