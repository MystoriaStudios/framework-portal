...
export default function OrganizationAuthWrapper({ id, children }) {
  ...
  // @ts-ignore
  return <OrganizationAuthWrapperServer id={id} organization_id={organization_id}>{children}</OrganizationAuthWrapperServer>
}

async function OrganizationAuthWrapperServer({ id, organization_id, children }) {
  ""
  try {
